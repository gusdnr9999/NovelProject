...
public class NaverNewsSearch {
    ...
    public static List<NewsVO> newsSearchData(String fd)
    {
        ...
        String clientId = "GZc84b3o536QflrTcQpN"; //애플리케이션 클라이언트 아이디
        String clientSecret = "GHnbTXM_py"; //애플리케이션 클라이언트 시크릿
        ...
        try  
        {
            ...
            for(int i=0;i<items.size();i++)
            {
                ...
                // Tue, 21 Jan 2025 12:42:00 +0900 => SmpleDateFormat 활용 변경
